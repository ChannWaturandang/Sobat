...
<head>
    ...
    <title>Informasi Obat - Apotek Sehat</title>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th>Harga</th>
                    <th>Stok</th>
                    <!-- Tampilkan header kategori atau satuan berdasarkan opsi -->
                    <?php if ($data['opsi'] == 'kategori'): ?>
                        <th>Kategori</th>
                    <?php elseif ($data['opsi'] == 'satuan'): ?>
                        <th>Satuan</th>
                    <?php endif; ?>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($data['info_obat'] as $dat): ?>
                    <tr>
                        ...
                        <!-- Tampilkan data kategori atau satuan -->
                        <?php if ($data['opsi'] == 'kategori'): ?>
                            <td><?= htmlspecialchars($dat['kategori']); ?></td>
                        <?php elseif ($data['opsi'] == 'satuan'): ?>
                            <td><?= htmlspecialchars($dat['satuan']); ?></td>
                        <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
            </tbody>
